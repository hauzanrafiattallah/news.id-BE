      ...
      <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div
          ...
          <a href="detail-MotoGp.html">
            ...
            <img src="{{ asset('storage/' . $news[0]->thumbnail) }}" alt="berita1" class="rounded-2xl" style="width: 100%; height: 350px; object-fit: cover;">
        ...
        <a href="detail-MotoGp.html"
          ...
          <img src="{{ asset('storage/' . $news->thumbnail) }}" alt="berita2" class="rounded-xl md:max-h-48" style="width: 250px;object-fit: cover;">
          <div class="mt-2 md:mt-0">
            <p class="font-semibold text-lg">{{ $news->title }}</p>
            <p class="text-slate-400 mt-3 text-sm font-normal">{{ \Str::limit(strip_tags($news->content), 150, '...') }}</p>
          </div>
        </a>  
        @endforeach
      </div>
